 ...
 */
export function parseBoolean(value: string | undefined | null, defaultValue: boolean): boolean {
  if (!value) return defaultValue
 ...
 */
export function getConfigValue<T extends Record<string, any>, K extends keyof T>(
  config: any,
  key: K,
  defaultValue: T[K]
): T[K] {
